                    ...
                    <div class="d-flex flex-wrap gap-3 mb-4 mb-lg-5">
                        @guest
                            <a href="{{ route('register') }}"
                                class="btn btn-danger btn-lg rounded-pill px-4 fw-semibold">Create your account</a>
                            <a href="{{ route('login') }}"
                                class="btn btn-outline-dark btn-lg rounded-pill px-4 fw-semibold">Already have an
                                account?</a>
                        @endguest
            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-12 col-lg-4 text-lg-end">
                    <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                        @guest
                            <a href="{{ route('login') }}" class="btn btn-light btn-lg rounded-pill px-4 fw-semibold">Log
                                in</a>
                            <a href="{{ route('register') }}"
